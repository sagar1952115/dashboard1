...
const EnvironmentVariable = () => {
  ...
  useEffect(() => {
    // Retrieve environment variables from localStorage
...
//   const handleDeleteVariable = (appId, index) => {
//     const updatedVariables = { ...variables };
//     updatedVariables[appId].splice(index, 1);
//     setVariables(updatedVariables);
//     localStorage.setItem("variables", JSON.stringify(updatedVariables));
//   };

//   const handleChangeKey = (appId, index, value) => {
//     const updatedVariables = { ...variables };
//     updatedVariables[appId][index].key = value;
//     setVariables(updatedVariables);
//     localStorage.setItem("variables", JSON.stringify(updatedVariables));
//   };

//   const handleChangeValue = (appId, index, value) => {
//     const updatedVariables = { ...variables };
//     updatedVariables[appId][index].value = value;
//     setVariables(updatedVariables);
//     localStorage.setItem("variables", JSON.stringify(updatedVariables));
//   };
...
//           </div>
//         </div>
//         {variables[selectedApp.id]?.length > 0 ? (
//           <div className="flex flex-col w-1/2 gap-3 py-3">
//             {variables[selectedApp.id].map((variable, index) => (
//               <div
//                 key={index}
//                 className="flex items-center justify-between p-3 text-sm text-black border rounded border-slate-200 "
//               >
...
//                 <img
//                   className="cursor-pointer"
//                   onClick={() => handleDeleteVariable(selectedApp.id, index)}
//                   src={deleteIcon}
//                   alt=""
//                 />
//               </div>
...
//             handleChangeValue={handleChangeValue}
//             handleAddVariable={handleAddVariable}
//             variables={variables[selectedApp.id] || []}
//             setVariables={setVariables}
//           />
//         )}
//         {open === "drag" && (
